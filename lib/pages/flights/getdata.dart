    ...
    if(response.statusCode == 200){
      showDialog(
        ...
        builder: (ctx) => AlertDialog(
          ...
          content: const Text("You deleted your data successfully!"),
        ),
      ).then((value){
        Navigator.push(
            context,
              ...
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                  ...
                  if(isData){
                    ...
                    padding: EdgeInsets.all(10),
                    child: Text('no data found! \n ensure that your booking Id is correct and your booking date is not more than a day ago.'  , style: TextStyle(
                      fontSize: 20
                    ),),
                  );
