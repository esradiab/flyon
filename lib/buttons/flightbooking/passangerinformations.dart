...
class PassengerInformation extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    ...
    return _PassengerInformation(adult, child, infant, flightType, flightDate,
        from, to, depTime, arrTime, airlineId, flightId);
  }
}
...
class _PassengerInformation extends State<PassengerInformation> {
  ...
  late List<String> firstNameAdult = [
    'adults first name',
    ' ',
    ' ',
    ' ',
  ...
  late List<String> fatherNameAdult = [
    'adults father name',
    ' ',
    ' ',
    ' ',
  ...
  late List<String> lastNameAdult = [
    'adults last name',
    ' ',
    ' ',
    ' ',
  ...
  late List<String> firstNameChild = [
    'children first name',
    ' ',
    ' ',
    ' ',
  ...
  late List<String> fatherNameChild = [
  ...
  late List<String> lastNameChild = [
    'children last name',
    ' ',
    ' ',
    ' ',
  ...
  late List<String> childrenGender = [
    'children gender',
    'male',
    'male',
    'male',
  ...
  Future insertFlightData() async {
    var url = Uri.parse("http://172.20.10.5/booking/insertflightdata.php");
    var headers = {'Content-Type': 'application/x-www-form-urlencoded'};
    var request = http.Request('POST', url);
    request.bodyFields = {
      'dep_iata': from,
                ...
                MaterialButton(
                  onPressed: () {
                    if (formKey.currentState!.validate()) {
                      ...
                      bookingID = uuid.v4().substring(0, 13);
