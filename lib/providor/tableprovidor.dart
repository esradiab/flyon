...
import 'package:untitled/model/tablemodel.dart';
...
class TableProvider extends ChangeNotifier {
  ...
  Future getData() async {
    ...
    var response = await https
        .get(Uri.parse('http://airlabs.co/api/v9/schedules?dep_iata=MJI&api_key=3db1de03-948f-442f-a84f-90a54ac7666b'));

    // now we have response as String from local json or and API request...
          var mJson = jsonDecode(response.body);
         // we have a JSON.
          this.data = TableModel.fromJson(mJson);
